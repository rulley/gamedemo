...
class ChartLegendTitle extends \Kendo\SerializableObject {
//>> Properties
    ...
    * @param string $value
    * @return \Kendo\Dataviz\UI\ChartLegendTitle
    */
    ...
    * @param \Kendo\Dataviz\UI\ChartLegendTitleBorder|array $value
    * @return \Kendo\Dataviz\UI\ChartLegendTitle
    */
    ...
    * @param float|\Kendo\Dataviz\UI\ChartLegendTitleMargin|array $value
    * @return \Kendo\Dataviz\UI\ChartLegendTitle
    */
    ...
    * @param float|\Kendo\Dataviz\UI\ChartLegendTitlePadding|array $value
    * @return \Kendo\Dataviz\UI\ChartLegendTitle
    */
