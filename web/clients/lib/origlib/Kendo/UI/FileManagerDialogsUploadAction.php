...
class FileManagerDialogsUploadAction extends \Kendo\SerializableObject {
//>> Properties

    /**
    * The text to be shown in the action's button.
    * @param string $value
    * @return \Kendo\UI\FileManagerDialogsUploadAction
    */
    ...
    /**
    * Sets the action option of the FileManagerDialogsUploadAction.
