...
//>> Properties
    ...
    */
    ...
    /**
    * The content-type HTTP header sent to the server. Defaults to "application/x-www-form-urlencoded". Use "application/json" if the content is JSON. Refer to the jQuery.ajax documentation for further information.
    * @param string $value
    * @return \Kendo\Data\DataSourceTransportUpdate
    */
    ...
    */
    ...
    /**
    * The URL to which the request is sent.If set to a function, the data source will invoke it and use the result as the URL.
