...
//>> Properties
    ...
    */
    public function accentFoldingFiltering($value) {
        return $this->setProperty('accentFoldingFiltering', $value);
    }
    ...
    * @return \Kendo\Data\DataSource
    */
    public function groupPaging($value) {
        return $this->setProperty('groupPaging', $value);
    }
