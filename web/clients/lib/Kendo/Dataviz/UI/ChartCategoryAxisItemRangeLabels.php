...
class ChartCategoryAxisItemRangeLabels extends \Kendo\SerializableObject {
//>> Properties

    /**
    * The background color of the labels. Accepts a valid CSS color string, including hex and rgb.
    * @param string $value
    * @return \Kendo\Dataviz\UI\ChartCategoryAxisItemRangeLabels
    */
    ...
    * @param \Kendo\Dataviz\UI\ChartCategoryAxisItemRangeLabelsBorder|array $value
    * @return \Kendo\Dataviz\UI\ChartCategoryAxisItemRangeLabels
    */
    ...
    * @param \Kendo\Dataviz\UI\ChartCategoryAxisItemRangeLabelsDateFormats|array $value
    * @return \Kendo\Dataviz\UI\ChartCategoryAxisItemRangeLabels
    */
    ...
    * @param float|\Kendo\Dataviz\UI\ChartCategoryAxisItemRangeLabelsMargin|array $value
    * @return \Kendo\Dataviz\UI\ChartCategoryAxisItemRangeLabels
    */
    ...
    * @param float|\Kendo\Dataviz\UI\ChartCategoryAxisItemRangeLabelsPadding|array $value
    * @return \Kendo\Dataviz\UI\ChartCategoryAxisItemRangeLabels
    */
    ...
    * @param float|string|\Kendo\Dataviz\UI\ChartCategoryAxisItemRangeLabelsRotation|array $value
    * @return \Kendo\Dataviz\UI\ChartCategoryAxisItemRangeLabels
    */
    ...
    /**
    * Sets the template option of the ChartCategoryAxisItemRangeLabels.
    ...
    */
    ...
    /**
    * Sets the visual option of the ChartCategoryAxisItemRangeLabels.
