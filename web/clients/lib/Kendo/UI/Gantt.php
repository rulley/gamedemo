...
//>> Properties
    ...
    * @return \Kendo\UI\Gantt
    */
    public function showPlannedTasks($value) {
        return $this->setProperty('showPlannedTasks', $value);
    }
    ...
    */
    ...
    /**
    * Sets the columnHide event of the Gantt.
    ...
    */
    ...
    /**
    * Sets the columnReorder event of the Gantt.
    ...
    */
    ...
    /**
    * Sets the columnShow event of the Gantt.
    ...
    */
    ...
    /**
    * Sets the togglePlannedTasks event of the Gantt.
    ...
    * @return \Kendo\UI\Gantt
    */
    public function togglePlannedTasks($value) {
        if (is_string($value)) {
            $value = new \Kendo\JavaScriptFunction($value);
        }

        return $this->setProperty('togglePlannedTasks', $value);
    }
