...
class TaskBoardToolbarItem extends \Kendo\SerializableObject {
//>> Properties

    /**
    * Specifies the type of the button.
    * @param string $value
    * @return \Kendo\UI\TaskBoardToolbarItem
    */
    ...
    */
    ...
    /**
    * Sets the click option of the TaskBoardToolbarItem.
    ...
    */
    ...
    /**
    * Sets the template option of the TaskBoardToolbarItem.
