...
//>> Properties
    ...
    * @return \Kendo\UI\EditorMessages
    */
    public function tableAlignLeft($value) {
        return $this->setProperty('tableAlignLeft', $value);
    }
    ...
    * @return \Kendo\UI\EditorMessages
    */
    public function tableAlignCenter($value) {
        return $this->setProperty('tableAlignCenter', $value);
    }
    ...
    * @return \Kendo\UI\EditorMessages
    */
    public function tableAlignRight($value) {
        return $this->setProperty('tableAlignRight', $value);
    }
    ...
    */
    public function applyFormat($value) {
        return $this->setProperty('applyFormat', $value);
    }
    ...
    * @return \Kendo\UI\EditorMessages
    */
    public function copyFormat($value) {
        return $this->setProperty('copyFormat', $value);
    }
    ...
    * @return \Kendo\UI\EditorMessages
    */
    public function insertUpperRomanList($value) {
        return $this->setProperty('insertUpperRomanList', $value);
    }
    ...
    * @return \Kendo\UI\EditorMessages
    */
    public function insertLowerRomanList($value) {
        return $this->setProperty('insertLowerRomanList', $value);
    }
