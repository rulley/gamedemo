...
//>> Properties
    ...
    * @return \Kendo\UI\Grid
    */
    public function encodeTitles($value) {
        return $this->setProperty('encodeTitles', $value);
    }
    ...
    * @return \Kendo\UI\Grid
    */
    public function loaderType($value) {
        return $this->setProperty('loaderType', $value);
    }
    ...
    * @param boolean|string|\Kendo\UI\GridSelectable|array $value
    * @return \Kendo\UI\Grid
    */
    ...
    * Fired when the user selects a table row or cell in the grid.The event handler function context (available via the this keyword) will be set to the widget instance.The event will be fired only when the Grid is selectable.
    * @param string|\Kendo\JavaScriptFunction $value Can be a JavaScript function definition or name.
    * @return \Kendo\UI\Grid
    */
    ...
    */
    ...
    /**
    * Sets the columnStick event of the Grid.
    ...
    * @return \Kendo\UI\Grid
    */
    public function columnStick($value) {
        if (is_string($value)) {
            $value = new \Kendo\JavaScriptFunction($value);
        }

        return $this->setProperty('columnStick', $value);
    }
    ...
    */
    ...
    /**
    * Sets the columnUnstick event of the Grid.
    ...
    * @return \Kendo\UI\Grid
    */
    public function columnUnstick($value) {
        if (is_string($value)) {
            $value = new \Kendo\JavaScriptFunction($value);
        }

        return $this->setProperty('columnUnstick', $value);
    }
