...
class FileManagerDialogsRenamePromptAction extends \Kendo\SerializableObject {
//>> Properties

    /**
    * The text to be shown in the action's button.
    * @param string $value
    * @return \Kendo\UI\FileManagerDialogsRenamePromptAction
    */
    ...
    /**
    * Sets the action option of the FileManagerDialogsRenamePromptAction.
