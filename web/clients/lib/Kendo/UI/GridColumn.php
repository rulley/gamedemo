...
//>> Properties
    ...
    */
    ...
    /**
    * Sets the data source of the GridColumn.
    ...
    * @param boolean|\Kendo\UI\GridColumnExportable|array $value
    * @return \Kendo\UI\GridColumn
    */
    public function exportable($value) {
        return $this->setProperty('exportable', $value);
    }
    ...
    * @param boolean|\Kendo\UI\GridColumnGroupable|array $value
    * @return \Kendo\UI\GridColumn
    */
    ...
    */
    public function sticky($value) {
        return $this->setProperty('sticky', $value);
    }
    ...
    * @return \Kendo\UI\GridColumn
    */
    public function stickable($value) {
        return $this->setProperty('stickable', $value);
    }
