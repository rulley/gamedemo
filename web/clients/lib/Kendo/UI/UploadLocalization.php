...
//>> Properties
    ...
    * @return \Kendo\UI\UploadLocalization
    */
    public function headerStatusPaused($value) {
        return $this->setProperty('headerStatusPaused', $value);
    }
    ...
    */
    public function uploadSuccess($value) {
        return $this->setProperty('uploadSuccess', $value);
    }
    ...
    * @return \Kendo\UI\UploadLocalization
    */
    public function uploadFail($value) {
        return $this->setProperty('uploadFail', $value);
    }
